...
    <div class="cart-item">
        <img src="${getImageUrl(item.product.image_url)}" alt="${item.product.make || ''}">
        <div class="cart-item-info">
            <div class="name">${item.product.year || ''} ${item.product.make || ''} ${item.product.model || ''}</div>
            <div class="price">$${item.product.price ? item.product.price.toLocaleString() : 'N/A'} each</div>
        </div>
        <div class="cart-qty">
