...
    const formData = new FormData();
    ...
    // FIX: Safely grab the value from the 'email' input box, since 'username' ID doesn't exist
    const userInputField = document.getElementById('email') || document.getElementById('username');
    
    formData.append('username', userInputField.value);
